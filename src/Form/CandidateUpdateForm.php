...
/**
 * @OA\Schema(
 *     required={"candidateStatus","fullName","position","phone", "socials","assignToId","vacancy_id","is_responded"},
 *     title="Create Candidate form"
 * )
 */
final class CandidateUpdateForm extends \App\Model\BaseModel
{
    /**
     * @OA\Property(
     *     format="string",
