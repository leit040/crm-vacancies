 ...
 *     title="Update vacancy form"
 * )
 */
final class VacancyUpdateForm extends \App\Model\BaseModel
{
    /**
     * @OA\Property(
     *     format="string",
    ...
    /**
     * @OA\Property(property="publications", type="array", @OA\Items(ref="#/components/schemas/VacancyPublicationUpdateForm")),
     * )
     */
    ...
    {
        return [
            [['name', 'position', 'rate', 'vacancyStatus', 'assignTo', 'description', 'isRemote'], 'required'],
            [['assignTo'], 'string', 'max' => 36],
